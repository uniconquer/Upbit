...
> 새 기능: **적응형 모의매매** 메뉴에서 가상 10만 원 포트폴리오의 연구 결과와
> 현재 시세 관찰 기록을 확인할 수 있습니다.
> [전략·실험 결과·실행 방법](docs/adaptive-portfolio-2026-09-06.md).
> 현재 판정은 연구용이며 실전 투입 기준을 충족하지 못했습니다.

> 2026-09-06 업데이트: 현재 코드는 아래 초기 소개보다 확장되어 공통 전략 엔진,
> 모의매매·위험 관리·실거래 워커·테스트를 포함합니다.
> [수익성 점검 결과와 재현 방법](docs/strategy-validation-2026-09-06.md)을 먼저 확인하세요.
> 공개 시세만 사용하는 검증 명령: `py -3 -m src.strategy_validation`.
> 이 명령은 실제 주문을 보내거나 실행 중인 워커 설정을 변경하지 않습니다.
